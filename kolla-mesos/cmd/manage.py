...
def main():
    ...
    # start the apps
    #kolla.start()
    #curl -X POST http://$HOST_IP:8080/v2/apps -d @marathon/mariadb.json -H "Content-type: application/json"
    #kolla.cleanup()
