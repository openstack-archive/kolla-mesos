...
# TODO(nihilifer): Propose this client to
# https://github.com/mesosphere/dcos-cli or any other project which aims
# to provide a Python client for Chronos.
...
class Client(object):
    ...
    def add_job(self, job_resource):
        ...
        response = marathon._http_req(http.port, url, json=job_resource,
    ...
    def get_jobs(self):
        ...
        response = marathon._http_req(http.get, url, timeout=self._timeout)
