...
class RenderNovaConfTest(base.BaseTestCase):
    ...
    def _define_variables(self):
        variables = {'enable_ironic': 'no',
                     ...
                     'keystone_auth_host': 'keystone-api-keystone-openstack-did.mfrm.mdom',
                     'neutron_server_host': 'neutron-server-neutron-openstack-did.mfrm.mdom',
                     'glance_api_host': 'glance-api-glance-api-openstack-did.mfrm.mdom',
                     'cinder_api_host': 'cinder-api-cinder-openstack-did.mfrm.mdom',
